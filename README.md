...
Guests can chat without signing in. When Auth0 is configured, users can sign in while anonymous chat remains available. PostgreSQL/Prisma persistence, streaming, uploads, and analytics remain separate follow-up work.
